...
declare
function local:position-minus-item ($item as xs:integer, $position as xs:integer) as xs:integer {
    $position - $item
};

declare
function local:lt-position-squared ($item as xs:integer, $position as xs:integer) as function(*) {
...
xbow:for-each-index(array { (0 to 4) }, local:position-minus-item#2),
