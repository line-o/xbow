...
declare
    %test:assertEquals(2)
function xbow-categorize-spec:numbers () {
    (-10 to 10)
...
declare
    %test:assertEquals(0)
function xbow-categorize-spec:none-match () {
    (0 to 10)
...
declare
    %test:assertEquals(2)
function xbow-categorize-spec:number-of-categories () {
...
function xbow-categorize-spec:number-of-items () {
    $xbow-spec:user-xml/user
        => xbow:categorize(
            [ xbow:lt(21), xbow:ge(21) ],
            xbow-spec:age-accessor#1
...
function xbow-categorize-spec:label-items () {
    $xbow-spec:user-xml/user
        => xbow:categorize(
            [ xbow:lt(21), xbow:ge(21) ],
            xbow-spec:age-accessor#1
